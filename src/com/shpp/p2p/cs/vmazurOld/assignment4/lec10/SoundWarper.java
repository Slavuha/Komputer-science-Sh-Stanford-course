...
public class SoundWarper extends TextProgram {
    ...
    public void run() {
        double[] clip = com.shpp.cs.a.lectures.lec10.StdAudio.read("assets/puppy.wav");
...
/* Play the clip normally. *//*
        ...
        com.shpp.cs.a.lectures.lec10.StdAudio.play(clip);
        pause(1000);
...
/* Ssllooww ddoowwnn tthhee cclliipp. *//*
        ...
        println("Slower...");
        com.shpp.cs.a.lectures.lec10.StdAudio.play(slowDown(clip));
        pause(1000);
...
/* Spd th clp p! *//*
        ...
        println("Faster...");
        com.shpp.cs.a.lectures.lec10.StdAudio.play(speedUp(clip));
    }
